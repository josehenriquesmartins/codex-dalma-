...
CREATE TABLE financeiro_liberacoes (
    ...
    nome_original_boleto VARCHAR(255) NULL,
    nome_arquivo_fisico_boleto VARCHAR(255) NULL,
    caminho_arquivo_boleto VARCHAR(255) NULL,
    extensao_boleto VARCHAR(10) NULL,
    tamanho_bytes_boleto BIGINT NULL,
    data_hora_upload_boleto TIMESTAMP NULL,
    data_hora_criacao TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    data_hora_atualizacao TIMESTAMP NULL,
